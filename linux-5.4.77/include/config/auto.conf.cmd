deps_config := \
	...
	drivers/staging/media/sunxi/cedar/ion/Kconfig \
	drivers/staging/media/sunxi/cedar/ve/Kconfig \
	drivers/staging/media/sunxi/cedar/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "arm-linux-gnueabi-gcc (Linaro GCC 7.2-2017.11) 7.2.1 20171011"
include/config/auto.conf: FORCE
endif
...
ifneq "$(NM)" "arm-linux-gnueabi-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-linux-gnueabi-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
