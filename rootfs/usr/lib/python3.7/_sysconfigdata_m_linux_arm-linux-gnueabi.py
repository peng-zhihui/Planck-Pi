...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/usr/bin',
 'BINLIBDEST': '/usr/lib/python3.7',
 'BLDLIBRARY': '-lpython3.7m',
 'BLDSHARED': 'arm-linux-gnueabi-gcc -pthread -shared -Wl,-O1 '
              '-Wl,-Bsymbolic-functions '
              ' -Wl,-z,relro',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'armv7l-unknown-linux-gnueabi',
 'BYTESTR_DEPS': '\\',
 ...
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/usr' '--enable-ipv6' "
                ...
                "'CC=arm-linux-gnueabi-gcc' 'CFLAGS=-g "
                ' '
                ' -fstack-protector-strong '
                "-Wformat -Werror=format-security ' "
                "'LDFLAGS= "
                "-Wl,-z,relro' 'CPPFLAGS=-Wdate-time -D_FORTIFY_SOURCE=2'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.7m',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared/coverage.info',
 'COVERAGE_REPORT': '/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include -Wdate-time '
             '-D_FORTIFY_SOURCE=2',
 'CXX': 'arm-linux-gnueabi-g++ -pthread',
 'DESTDIRS': '/usr /usr/lib /usr/lib/python3.7 /usr/lib/python3.7/lib-dynload',
 'DESTLIB': '/usr/lib/python3.7',
 'DESTPATH': '',
 ...
 'EXEMODE': 755,
 'EXTRATESTOPTS': '',
 'EXT_SUFFIX': '.cpython-37m-arm-linux-gnueabi.so',
 'FILEMODE': 644,
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'armv7l-unknown-linux-gnueabi',
 'INCLDIRSTOMAKE': '/usr/include /usr/include /usr/include/python3.7m '
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'arm-linux-gnueabi-g++ -pthread -shared -Wl,-O1 '
                '-Wl,-Bsymbolic-functions',
 'LDFLAGS': ' -Wl,-z,relro',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.7m.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'arm-linux-gnueabi-gcc -pthread -shared -Wl,-O1 '
             '-Wl,-Bsymbolic-functions '
             ' -Wl,-z,relro',
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/usr/lib/python3.7',
 'LIBDIR': '/usr/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/usr/lib/arm-linux-gnueabi/pkgconfig',
 'LIBPL': '/usr/lib/python3.7/config-3.7m-arm-linux-gnueabi',
 'LIBRARY': 'libpython3.7m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lcrypt -lpthread -ldl  -lutil',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'arm-linux-gnueabi-gcc -pthread',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'arm-linux-gnueabi-gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODBUILT_NAMES': 'array  cmath  math  _struct  _random  _elementtree  '
                   '_pickle  _datetime  _bisect  _heapq  unicodedata  fcntl  '
                   'spwd  grp  select  _socket  _posixsubprocess  _md5  _sha1  '
                   '_sha256  _sha512  _sha3  _blake2  syslog  binascii  zlib  '
                   'pyexpat  posix  errno  pwd  _sre  _codecs  _weakref  '
                   '_functools  _operator  _collections  _abc  itertools  '
                   'atexit  _signal  _stat  time  _thread  _locale  _io  '
                   'zipimport  faulthandler  _tracemalloc  _symtable  '
                   'xxsubtype',
 'MODDISABLED_NAMES': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'SIZEOF_WCHAR_T': 4,
 'SIZEOF__BOOL': 1,
 'SOABI': 'cpython-37m-arm-linux-gnueabi',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared '
 ...
 'abs_builddir': '/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared',
 'abs_srcdir': '/build/python3.7-HtKwSv/python3.7-3.7.3/build-shared/..',
